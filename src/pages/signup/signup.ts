...
constructor(public navCtrl: NavController,public apip:ApiintegrateProvider,public alertp:AlerttProvider,public navParams: NavParams,public alertcontroller:AlertController) {
  }
  ...
  validate(){
    ...
    if(this.first_name==undefined||this.first_name==""){
      ...
      else{if(!(this.first_name.match(this.namepattern))){
      ...
      if(this.last_name==undefined||this.last_name==""){
        ...
        else{if(!(this.last_name.match(this.namepattern))){
      ...
      if(this.email==undefined||this.email==""){
        this.mess="email name cant be empty";this.alertp.presentAlert(this.mess);}
          ...
          if(this.pass==undefined||this.pass==""){
            this.mess="password cant be empty";this.alertp.presentAlert(this.mess);}else{if(!(this.pass.match(this.passpattern))){
            ...
            if(this.pass1==undefined||this.pass1==""){
              this.mess="password can not be empty";this.alertp.presentAlert(this.mess);}else{if(!(this.pass1.match(this.pass))){
                 this.mess="passwords dont match";this.alertp.presentAlert(this.mess);;
            }else{
    if(this.mobile==undefined||this.mobile==""){
      this.mess="mobile number cant be empty";this.alertp.presentAlert(this.mess);}else{if(!(this.mobile.match(this.phonepattern))){
        this.mess="invalid number";this.alertp.presentAlert(this.mess);
             
      }else{if(this.mess==undefined||this.mess==""||this.mess==null){
        this.alertp.presentAlert(this.mess);
        var method="post";
