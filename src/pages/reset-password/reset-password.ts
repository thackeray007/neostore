...
export class ResetPasswordPage {
    ...
    editPass($event) {
        ...
        if (this.alertp.valid(this.pass, "old password") == true) {

        } else {
            if (this.alertp.valid(this.pass1, "new password") == true) {
                return 0
            } else {
                if (this.alertp.valid(this.pass2, "new password") == true) { return 0 }
                ...
                //         if (this.pass2 == "" || this.pass2 == undefined) { this.alertp.presentAlert("password cant be blank") }
                    ...
                    if (this.alertp.matchpass(this.pass1, this.pass2)) { return 0; }
                    else {
